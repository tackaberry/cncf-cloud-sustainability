...
In the not too distant past I ran RHOK and Tech4Good - as a way to bring tech and innovation to social sector. I also contributed to Ottawa Civic Tech. 
...
Over the last 3 years I adjusted my path slightly to focus my efforts and growth on understanding how I can contribute to the climate crisis. In addition to learning and working on tech that helps us better understand our climate, how to adapt to it, and mitigate climate-related risks,  I've also been working on how to make the internet and IT more sustainable.  This is what I'm going to talk about today. 
...
The digital industry is responsible for between 2 and 5 % of global emissions.  This is expected to grow to well over 10% by 2040.
...
This ICT consumption is going to increase and grow rapidly with the computation needs of AI, increased traffic from IoT, and the growth of the internet in general.
...
Lighthouse is a tool built into Google Chrome Dev Tools that will give you a view of the performance of your website.  It will give you a score for performance, accessibility, best practices, SEO, and PWA.  It will also give you a view of the carbon footprint of your website.  This is a great tool to help you understand the impact of your website and to help you make decisions about how to optimize it.
...
We all know Quebec produces clean energy. it produces more than it can use and ships the remainder down south to the states.  what happens when it does that?  the states have to turn off their clean energy sources and turn on their dirty energy sources.  Its important to also build for energy efficiency - which brings us to #4. 
...
Also schedule workloads to run when power is cleanest.
...
Lastly, using the right chip architecture is better for energy efficiency. First, upgrade to the latest verison as your cloud provider makes it available. Choose the right chip for the job, and don't overprovision. 
...
The AWS WAS Susty pillar is a great resource for understanding how to build sustainable software - with best practices on how to implement on AWS.  
...
- Check out the resources on the [repo]()
